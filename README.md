...
- 2024-2026 \
  Глава Центра Цифровых Коммуникаций Студенческого совета ЭМИТ Президентской Академии
- 2024-2025 \
  Руководитель Карьерного и Научного студенческого общества ЭМИТ Президентской Академии
- 2026 \
...
<div>
  ...
  <p><strong>Сборщики и инструменты</strong></p>
  ...
  <p><strong>Data Science и анализ</strong></p>
  ...
  <!-- Контейнеризация и ОС -->
  <p><strong>Контейнеризация и ОС</strong></p>
  ...
  <p><strong>Системы контроля версий</strong></p>
  <code><img width="50" src="https://raw.githubusercontent.com/marwin1991/profile-technology-icons/refs/heads/main/icons/git.png" alt="Git" title="Git"/></code>

  <p><strong>API тестирование и документация</strong></p>
...
- Научная статья и исследование в области Computer Science для выявления объектов на снимках ортофотопланов
- Подготовка к поступлению в ШАД Яндекса и AI Masters МГУ
